...
| --- | --- | ---: | ---: | ---: | ---: |
| 무작위 | insertionSort | 10.268 | 3,950,647 | 3,950,655 | 1 |
| 무작위 | bubbleSort | 29.564 | 7,997,922 | 11,828,007 | 1 |
| 무작위 | **blockSort** | **0.719** | **115,971** | 352,201 | 16 |
| 정렬됨 | insertionSort | 0.004 | 3,999 | 0 | 1 |
| 정렬됨 | bubbleSort | 0.005 | 3,999 | 0 | 1 |
| 정렬됨 | blockSort | 0.004 | 3,999 | 0 | 1 |
| 역순 | insertionSort | 21.349 | 8,001,999 | 8,005,998 | 1 |
| 역순 | bubbleSort | 30.241 | 7,998,000 | 23,994,000 | 1 |
| 역순 | **blockSort** | **0.541** | **133,851** | 311,166 | 24 |
| 중복많음 | insertionSort | 9.253 | 3,575,497 | 3,575,032 | 1 |
| 중복많음 | bubbleSort | 27.955 | 7,867,695 | 10,703,898 | 1 |
| 중복많음 | **blockSort** | **0.429** | **74,499** | 238,678 | 21 |
...
- 블록 정렬이 `정렬됨`을 빼면 세 묶음에서 거의 같은 높이(0.429~0.719ms)라는 것도
...
| ---: | ---: | ---: | ---: |
| 1,000 | 0.657 | 1.709 | 0.135 |
| 2,000 | 2.586 | 6.751 | 0.304 |
| 4,000 | 10.014 | 28.668 | 0.702 |
| 8,000 | 41.011 | 120.856 | 1.863 |

![n이 커질 때 걸린 시간 — 선형 축](growth-time.svg)

`n = 8,000`에서 블록 정렬은 버블 정렬보다 **65배** 빠르다.
